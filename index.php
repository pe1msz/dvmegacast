...
<form action="check_update.php" method="post" enctype="multipart/form-data">
   <table>
  <tr>
        <h3>DVMEGA-Cast Special PiStar updates</h3>
  </tr>
  <tr>
       <center>This feature will download and modify the PiStar installation<BR><BR></center>
        <center><input type="submit" value="PiStar adjustment" name="submit"><BR><BR></center>
  </tr>
   </table>
